/*
  HTTPWithCallback Example:

  1.  Start the HTTP server via the python script in 'HTTPWithCallback/http_server'
        $ cd http_server
  ...
  5.  Run the example and open serial monitor to see the HTTP response
...
/*!
    @brief This function is called whenever new data is received from
           the feather.httpRequestWithCallback function
*/
/**************************************************************************/
