/*
  ...
  3.  Start the HTTPS server via the python script in 'AsyncHTTPS/https_server'
  ...
  9.  Run the example and open serial monitor to see the async HTTPS request
...
/*!
    @brief This function is called whenever new data is received from
           the feather.asyncHttpsRequest function
*/
/**************************************************************************/
...
void setup()
{
  ...
  Serial.println(F("HTTPS Async Callback Example\r\n"));
...
void loop() 
{
  ...
  if (wifi_error == 0)
  {
    ...
    if ( (https_error = feather.asyncHttpsRequest(URL, ca_cert, CONTENT, METHOD) ) != 0)
    {
